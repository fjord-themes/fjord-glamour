...
A dusk-blue base with primary leaf-green accents, cyan selections, and crisp blue/cyan separation for Glamour — the terminal markdown renderer used by tools like Glow and Charm.
...
For theme suggestions or issues, please open an issue on the [Glamour theme repository](https://github.com/fjord-themes/fjord-glamour/issues).